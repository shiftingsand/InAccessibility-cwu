...
struct Stock: Identifiable {
    ...
    static func favorites() -> [Stock] {
        [
            ...
            Stock(name: "Rechtsschutzversicherungsgesellschaften", shortName: "RECH", favorite: true),
    ...
    static func all() -> [Stock] {
        [
            Stock(name: "Apple", shortName: "AAPL", favorite: false),
            Stock(name: "Rechtsschutzversicherungsgesellschaften", shortName: "RECH", favorite: false),
